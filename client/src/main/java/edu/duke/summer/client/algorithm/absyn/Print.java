...
public class Print {
  ...
  void prExp(edu.duke.summer.client.algorithm.absyn.ArrayExp e, int d) {
...
//      }
  ...
  void prTy(Ty t, int i) {
    if (t!=null) {
      ...
      else if (t instanceof edu.duke.summer.client.algorithm.absyn.ArrayTy) prTy((ArrayTy) t, i);
