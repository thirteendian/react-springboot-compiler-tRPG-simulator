...
import edu.duke.summer.server.algorithm.errormsg.ErrorMsg;
import edu.duke.summer.server.algorithm.inputBaseVisitor;
import edu.duke.summer.server.algorithm.inputParser;
import edu.duke.summer.server.algorithm.inputLexer;
...
public class BuildASTVisitor extends inputBaseVisitor<Absyn> {
    ...
    @Override
    public Absyn visitProg(inputParser.ProgContext ctx) {
        ;
