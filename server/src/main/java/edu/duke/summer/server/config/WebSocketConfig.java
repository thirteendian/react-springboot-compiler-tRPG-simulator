...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry config) {
        //Return OUTPUT message destination, example: "/topic" as socketJs subscribe to "/topic/***"
        config.enableSimpleBroker("/objectcreate", "/admin","/gameServerCommunicator");
        //The prefix of @MessageMapping , example: client send to /app/hello as server receive from @MessageMapping(/hello)
        config.setApplicationDestinationPrefixes("/app", "/admin","/gameServerReceiver");
    }
